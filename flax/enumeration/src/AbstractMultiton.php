...
require_once __DIR__ . '/MultitonInterface.php';
require_once __DIR__ . '/Exception/ExtendsConcreteException.php';
require_once __DIR__ . '/Exception/UndefinedMemberException.php';
require_once __DIR__ . '/Exception/UndefinedMemberExceptionInterface.php';
