...
require_once __DIR__ . '/../../collections/src/Stack.php';
require_once __DIR__ . '/../../collections/src/Vector.php';
require_once __DIR__ . '/DecoderState.php';
require_once __DIR__ . '/../Exception/DecodeException.php';
