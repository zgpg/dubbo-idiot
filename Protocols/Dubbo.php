...
//require_once __DIR__ . '/Dubbo.php';
//require_once __DIR__ . '/Hessian.php';
//require_once __DIR__ . '/JsonRPC.php';
//require_once __DIR__ . '/AbstractProtocol.php';
require_once __DIR__ . '/../flax/src/Serialization/Encoder.php';
require_once __DIR__ . '/../Utility.php';
require_once __DIR__ . '/../flax/src/Serialization/Decoder.php';
//use stdClass;
use Exception;
//use Idiot\Adapter;
use Idiot\Type;
