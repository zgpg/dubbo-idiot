 ...
 */
namespace Idiot;
require_once __DIR__ . '/Protocols/Dubbo.php';
//require_once __DIR__ . '/Protocols/Hessian.php';
//require_once __DIR__ . '/Protocols/JsonRPC.php';
//require_once __DIR__ . '/Protocols/AbstractProtocol.php';
require_once __DIR__ . '/Languages/AbstractLanguage.php';
require_once __DIR__ . '/Languages/Java.php';
use Exception;
